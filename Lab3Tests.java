...
//	@Test
//	void testAddRational() throws Exception{
//		List<SpecialNumber> A = new ArrayList<SpecialNumber>();
//		A.add(new RationalNumber(3,2));
//		A.add(new RationalNumber(1,1));
//		assertEquals(A.get(0).add(A.get(1)), new RationalNumber(5,2));
//	}
	
//	@Test
//	void testAverageRationalNumber2() throws Exception{
//		List<SpecialNumber> A = new ArrayList<SpecialNumber>();
//		A.add(new RationalNumber(3,2));
//		A.add(new RationalNumber(1,1));
//		assertEquals(SpecialNumber.computeAverage(A), new RationalNumber(5,4));
//	}
